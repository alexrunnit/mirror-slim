...
module.exports = async function handler(req, res) {
   ...
   // Run geocoding and extraction in parallel
...
Inspiration: "${content}"`
    ...
    if (extractResult) {
        const categoryMatch = extractResult.match(/CATEGORY:\s*(.+)/);
        const feelingMatch = extractResult.match(/FEELING:\s*(.+)/);
        const sourceMatch = extractResult.match(/SOURCE:\s*(.+)/);
